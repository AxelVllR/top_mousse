 ...
 */
final class Version20221212151249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE foam ADD reseller_price DOUBLE PRECISION DEFAULT NULL, ADD reseller_price_ht DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE foam DROP reseller_price, DROP reseller_price_ht');
    }
}
